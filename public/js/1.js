...
exports.default = {
  ...
  mounted: function mounted() {
    ...
    this.axios.get('account/lists').then(function (response) {
      ...
      window.localStorage.setItem('willchat_accounts', (0, _stringify2.default)(response.data.accounts));

      var temp = window.localStorage.getItem('willchat_accounts');

      _this.$store.commit('UPDATE_ACCOUNTS', JSON.parse(temp));
